package com.dd.dddada.service.impl;
...
import com.dd.dddada.constant.CommonConstant;
import com.dd.dddada.exception.ThrowUtils;
import com.dd.dddada.mapper.AppMapper;
import com.dd.dddada.model.dto.app.AppQueryRequest;
import com.dd.dddada.model.entity.App;
import com.dd.dddada.model.entity.User;
import com.dd.dddada.model.enums.AppScoreStrategyEnum;
import com.dd.dddada.model.enums.AppTypeEnum;
import com.dd.dddada.model.enums.ReviewStatusEnum;
import com.dd.dddada.model.vo.AppVO;
import com.dd.dddada.model.vo.UserVO;
import com.dd.dddada.service.AppService;
import com.dd.dddada.service.UserService;
import com.dd.dddada.utils.SqlUtils;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(appTypeEnum == null, ErrorCode.PARAMS_ERROR, "应用类型值不正确");
            AppScoreStrategyEnum scoreStrategyEnum = AppScoreStrategyEnum.getEnumByValue(scoringStrategy);
            ThrowUtils.throwIf(scoreStrategyEnum == null, ErrorCode.PARAMS_ERROR, "评分策略值不正确");
        }
        // 修改数据时，有参数则校验
        //  补充校验规则
        if (StringUtils.isNotBlank(appName)) {
            ThrowUtils.throwIf(appName.length() > 80, ErrorCode.PARAMS_ERROR, "应用名不能超过80个字符");
        }

        if (reviewStatus != null) {
            ReviewStatusEnum enumByValue = ReviewStatusEnum.getEnumByValue(reviewStatus);
            ThrowUtils.throwIf(enumByValue == null, ErrorCode.PARAMS_ERROR, "审核状态值不正确");
        }
    ...
    public QueryWrapper<App> getQueryWrapper(AppQueryRequest appQueryRequest) {
        ...
        // 模糊查询
        queryWrapper.like(StringUtils.isNotBlank(title), "appName", appName);
        queryWrapper.like(StringUtils.isNotBlank(content), "appDesc", appDesc);
